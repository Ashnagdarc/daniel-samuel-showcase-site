        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl animate-fade-in opacity-0 animation-delay-700">
                Transforming ideas into interactive and seamless digital experiences 
                with cutting-edge frontend development.
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4 animate-slide-in-right opacity-0 animation-delay-1000">
            ...
            <div className="flex space-x-6 animate-fade-in opacity-0 animation-delay-1200">
              <a
          ...
          <div className="flex justify-center lg:justify-end animate-slide-in-right opacity-0 animation-delay-800">
            <ProfileCard
              name="Daniel Samuel"
